...
const allowedOrigins: string[] = (
  ...
  'http://localhost:3000,http://localhost:3001,http://localhost:2000,http://localhost,http://46.243.211.198:3000,http://46.243.211.198:3001,http://46.243.211.198,http://flip7.ya-praktikum.tech,https://flip7.ya-praktikum.tech'
)
  .split(',')
  .map(o => o.trim())
  .filter(Boolean);
