...
export const changeUserPasswordThunk = thunkCreator<string, Partial<IUserPassword>>(
...
export const userSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(changeUserDataThunk.fulfilled, (state, { payload }: PayloadAction<Partial<IUser>>) => {
        state.data = payload;
        state.isLoading = false
      })
      ...
      .addCase(changeUserAvatar.fulfilled.type, (state, { payload }: PayloadAction<Partial<IUser>>) => {
        state.data = payload;
        state.isLoading = false
      })
