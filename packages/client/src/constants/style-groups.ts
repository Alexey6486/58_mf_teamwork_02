...
export const TOGGLE_BTN_ACTIVE_CLASS =
  'bg-f7-light-green text-main-white border-f7-light-green dark:bg-f7-light-green dark:border-f7-light-green hover:bg-f7-light-green hover:border-f7-light-green hover:text-main-white';
...
export const GAME_HEADER_CONTAINER_CLASS =
  'fixed z-10 w-full flex flex-row h-16 ';
...
export const CARD_BORDER_CLASS =
  'absolute z-0 w-[calc(100%-20px)] h-[calc(100%-20px)] top-[10px] left-[10px] border border-f7-yellow rounded-main-radius';
